 ...
 * @author Varga Bence
 */
@BitTable(propOrder = {"content"})
public class MovieDataBox extends Box {

    protected List<ByteArraySlice> content = new LinkedList<>();
    ...
    @BitField
    public List<ByteArraySlice> getContent() {
        return content;
    }

    public void setContent(List<ByteArraySlice> content) {
